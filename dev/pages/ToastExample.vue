...
<template>
  <div>
    ...
    <w-toast
      class="sm:mt-0"
      v-bind="toastOptions"
      text="This is how a toast looks! You can bring in the toast component manually for broadcast messages."
      :can-close="false" />

    <w-toggle
      v-model="activeExample"
      class="mt-32 bg-gray-100 p-16 inline-block rounded-4"
      radio
      label="Toast type"
      :toggles="exampleToasts" />

    <button class="mt-32 block button button--utility" @click="make">Make some toast</button>
