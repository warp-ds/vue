  ...
  <div>
    ...
    <token :state="smallNumber">
      <div class="flex gap-16">
        ...
        <w-slider v-model="smallNumber" :min="1" :max="10" :step="1" label="Small numbers slider" />
      </div>
    </token>
    ...
    <token :state="largeNumber">
      <div class="flex gap-16">
        ...
        <w-slider v-model="largeNumber" :min="0" :max="10000" :step="10" label="Large numbers slider (with step of 10)" />
      </div>
    </token>
    ...
    <token :state="extremeNumber">
      <div class="flex gap-16">
        ...
        <w-slider v-model="extremeNumber" :min="0" :max="100000000" :step="100" label="Extreme numbers slider (with step of 100)" />
      </div>
    </token>
    ...
    <token :state="slowNumber">
      <div class="flex gap-16">
        ...
        <w-slider v-model="slowNumber" :min="0" :max="1000" :step="1" prevent-acceleration label="Slider without keydown acceleration" />
      </div>
    </token>
  </div>
</template>
